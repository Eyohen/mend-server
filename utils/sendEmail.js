...
module.exports = async (from, email, subject, text, date, customer,sewing, alteration, price, advanced, medium,pickup,picktime) => {
	try {
		...
		await transporter.sendMail({
			...
			<body>
			  ...
			  <p style="padding-top: 20px; color: gray; font-size: 20px; font-weight: 100;">Pick-up date : ${new Date(pickup).toDateString()}, ${picktime}</p>
